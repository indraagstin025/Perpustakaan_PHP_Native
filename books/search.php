...
<body class="bg-gray-100 text-gray-900">
    ...
    <div class="pt-16 container mx-auto p-4">
        <h1 class="text-4xl font-bold mb-4">Search Results for "<?php echo htmlspecialchars($query); ?>"</h1>
        <form method="get" action="search.php" class="mb-4">
            <input type="text" name="query" placeholder="Search for books..." class="p-2 rounded bg-gray-200 text-gray-900 w-full md:w-1/2" value="<?php echo htmlspecialchars($query); ?>">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<p>No books found matching your query.</p>";
            }
            ?>
        </div>
    </div>
